...
The main goal of hecr is to allow a user to obtain and automate the process
of obtaining output data from an hdf file resulting from a HEC-RAS model run.
...
# you can also pull out an entire list of cross sections defined in the hdf file
# not very useful in this release of the package but future releases will make use of it
...
the same examples as above but this time getting time series for two dimension portions of
model files. 
